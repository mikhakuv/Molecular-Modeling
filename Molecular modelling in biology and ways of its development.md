...
где $\vec{F_{ex}}$ - сила взаимодействия атома с другими молекулами, а $U$ - потенциальная энергия, которая складывается из нескольких компонент:
...
$U_{\phi} = \sum_{i} \frac{v_i}{2}(1+cos(iw-\gamma_i))$ - потенциальная энергия торсионных углов. Формула Гука не используется потому, что у может быть несколько торсионных углов, в которых достигается минимум энергии

$U_b$ и $U_v$ соответствуют жёстким степеням свободы и нужно приложить много энергии, чтобы поменять величины, которым они соответствуют. Большинство изменений происходят как раз за счёт поворота торсионных углов и соответственно изменения $U_{\phi}$.
