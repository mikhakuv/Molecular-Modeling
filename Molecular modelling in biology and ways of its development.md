...
Молекулярное моделирование можно разделить на 3 области по степени детализации: квантовая механика, молекулярная динамика, броуновская динамика.
...
В то же время самый упрощённый метод - броуновская динамика, не учитывает внутримолекулярных взаимодействий, из-за чего не применим для симуляций на микроуровне. Примерные границы применимости методов при текущих вычислительных возможностях можно увидеть на графике:  

<p align="center"><img src="https://github.com/mikhakuv/Molecular_Modelling/blob/main/charts/chart1.PNG"></p>    
